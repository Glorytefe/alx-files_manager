...
/**
 * DBCLIENT Class for performing operations with Mongo service
 */
class DBClient {
  constructor() {
  ...
  /**
   * Validates if connection to Redis is Alive
  ...
  /**
   * Returns the number of docs in the collection files
